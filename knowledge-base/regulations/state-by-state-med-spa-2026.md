...
*Last updated: 2026-06-08. Compiled from landscape monitor runs 2026-04-12 through 2026-06-08. This is a curation reference for use by skills in this repo — not legal advice. Route to the practice's medical director and healthcare attorney for citation-level review and real-time status.*
...
- **Status (as of June 8, 2026)**: Second draft of the Code of Practice on Marking and Labelling of AI-Generated Content published; the European Commission's targeted stakeholder consultation on the draft transparency guidelines closed **June 3, 2026**. Final Code still not published as of this monitor cycle — finalization expected within June 2026, ahead of the August 2 applicability date. The Code is voluntary, but signatories will be presumed compliant with Article 50(2) (machine-readable marking) and 50(4) (labelling).
