...
- **Primary duty — Art. 50(1) "you are interacting with AI" (chatbot disclosure).** If an EU-facing AI booking bot, AI receptionist, or conversational scheduler handles the client, the client must be told, clearly and at the first interaction, that they are talking to AI. This is the part most operators' bots actually trip. *Note for the drafter (updated 2026-06-22 monitor):* the detailed scope of this duty lives in the Commission's Art. 50 **guidelines**, which were **published in DRAFT on 2026-05-08** (stakeholder consultation closed 2026-06-03); the **final** guidelines remain pending, expected ahead of the 2026-08-02 applicability date. The draft sharpens the duty in two operator-relevant ways, both safe to build to now: **(a)** the "this is AI" disclosure must surface **at the moment of first interaction** — it cannot be buried in terms-of-service, a settings menu, or a privacy policy; and **(b)** the duty **extends to "agentic" systems** that take actions on the client's behalf — an AI agent that books, reschedules, or cancels must disclose, not only a passive Q&A chatbot. Frame the disclosure as required-and-stable in substance while flagging that the final guideline text may refine the wording. This is the disclosure to lead with.
...
- **v1.2** — Refreshed the Artifact 4 Art. 50(1) chatbot-disclosure drafter note against the **2026-06-22** monitor hand-off: the Commission's Art. 50 **guidelines** were published in **DRAFT on 2026-05-08** (consultation closed 2026-06-03; final pending). Recorded the two draft sharpenings now safe to build to — disclosure at the **moment of first interaction** (not buried in ToS/settings/privacy policy) and extension of the duty to **agentic booking agents** that act on the client's behalf (book/reschedule/cancel), not only passive Q&A bots. Directional-but-not-final framing retained; re-check before 2026-08-02 for the authoritative text. Additive; no prior content removed.
