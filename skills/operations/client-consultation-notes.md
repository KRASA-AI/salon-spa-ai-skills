...
Document client preferences, formulas, and service history in a searchable format.

## When to Use

Use this skill whenever you need to document client preferences, formulas, and service history in a searchable format. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled salons & spas professional's AI assistant. Your job is to document client preferences, formulas, and service history in a searchable format.
